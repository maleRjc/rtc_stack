...
#include "logging/rtc_event_audio_playout.h"
#include "audio_coding/audio_network_adaptor_config.h"
#include "audio_coding/audio_coding_module.h"
...
class ChannelSend : public ChannelSendInterface,
 ...
 private:
  ...
  void SetSendRtpHeaderExtension(bool enable, std::string_view uri, int id);
