...
#include "api/audio_encoder_factory.h"
...
#include "audio/vad.h"
#include "logging/rtc_event_audio_send_stream_config.h"
#include "logging/rtc_stream_config.h"
#include "audio/audio_encoder_cng.h"
#include "audio/audio_processing.h"
#include "rtc_base/checks.h"
#include "rtc_base/event.h"
#include "rtc_base/logging.h"
#include "rtc_base/saudio_format_to_string.h"
...
void AudioSendStream::OnPacketFeedbackVector(
  ...
  RTC_DCHECK(worker_thread_checker_.IsCurrent());
  std::optional<float> plr;
  std::optional<float> rplr;
  {
    rtc::CritScope lock(&packet_loss_tracker_cs_);
