...
#include "api/video_stream_encoder_interface.h"
#include "api/video_stream_encoder_observer.h"
#include "api/video_stream_encoder_settings.h"
#include "api/video_codec.h"
#include "api/video_encoder.h"
//#include "video/frame_dropper.h"
#include "video/quality_scaler.h"
#include "rtc_base/critical_section.h"
#include "rtc_base/event.h"
//#include "rtc_base/balanced_degradation_settings.h"
#include "rtc_base/quality_scaler_settings.h"
...
public:
  ...
  ~VideoStreamEncoder() override = default;
 ...
 private:
  ...
  std::optional<VideoFrameInfo> last_frame_info_
  ...
  // or AdaptDown signal.
  std::optional<AdaptationRequest> last_adaptation_request_
      RTC_GUARDED_BY(&encoder_queue_);
  ...
  std::optional<VideoEncoder::ResolutionBitrateLimits> encoder_bitrate_limits_
      RTC_GUARDED_BY(&encoder_queue_);
  ...
  struct EncoderSwitchExperiment {
    ...
    std::optional<std::string> to_value;
