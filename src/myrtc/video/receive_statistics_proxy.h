...
class ReceiveStatisticsProxy : public VCMReceiveStatisticsCallback,
 ...
 private:
  ...
  std::optional<int64_t> first_frame_received_time_ms_ RTC_GUARDED_BY(&crit_);
  std::optional<int64_t> first_decoded_frame_time_ms_ RTC_GUARDED_BY(&crit_);
  std::optional<int64_t> last_decoded_frame_time_ms_ RTC_GUARDED_BY(&crit_);
  ...
  mutable rtc::MovingMaxCounter<TimingFrameInfo> timing_frame_info_counter_
      RTC_GUARDED_BY(&crit_);
  std::optional<int> num_unique_frames_ RTC_GUARDED_BY(crit_);
